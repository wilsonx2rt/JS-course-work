...
test('repetition: return an object with each string as a key and a number as value for each time the key is repeated',
function(t) {
	var actual = fn.repetitions(['kerouac', 'fante', 'fante', 'buk', 'hemingway', 'hornby', 'kerouac', 'buk', 'fante']);
	var expected = {
		kerouac: 2,
		fante: 3,
		buk: 2,
